<!-- pages/kitchens/[kitchenId]/edit.vue -->
<template>
  <client-only>
    <div class="page" v-if="kitchen && hasTeamAccess">
      ...
      <div class="header action-buttons">
        ...
        <NuxtLink :to="`/kitchens/${kitchen.id}`" class="icon-btn">
          <EyeIcon class="icon" />
          <span>View</span>
        </NuxtLink>
      </div>

      <!-- Kitchen Edit Content -->
      <template v-if="isAdmin">
        <OrganismsKitchenEdit :kitchen="kitchen" :deleteEntity="deleteKitchen" />
      </template>
      <p v-else class="error-message">You do not have permission to edit this kitchen.</p>
    </div>
